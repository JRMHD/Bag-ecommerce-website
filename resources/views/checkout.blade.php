                            ...
                            <div class="col-xl-9 col-lg-8 col-md-12 col-12">
                                ...
                                <div class="checkout-progress overflow-hidden">
                                    <ol class="checkout-bar px-0">
                                        ...
                                        <li class="progress-step step-active"><a href="checkout.html">Your Details</a>
                                        </li>
                                ...
                                <div class="checkout-user-area overflow-hidden d-flex align-items-center">
                                    ...
                                    <div
                                        ...
                                        <div class="checkout-user-info">
                                            ...
                                            <p class="checkout-user-address mb-0">2752 avenue Royale, Quebec, G1R 2B2,
                                                Canada</p>
                                        </div>
                                ...
                                <div class="shipping-address-area billing-area">
                                    <div
                                        ...
                                        <a href="cart.html" class="checkout-page-btn minicart-btn btn-secondary">BACK
                                            TO CART</a>
                                        <a href="checkout.html"
                                            class="checkout-page-btn minicart-btn btn-primary">PROCEED TO SHIPPING</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <h3 class="d-none d-lg-block mb-0 text-center heading_24 mb-4">Order summary</h4>
                                        ...
                                        <div class="minicart-item d-flex">
                                            ...
                                            <div class="product-info">
                                                <h2 class="product-title"><a href="#">Eliot Reversible
                                                        Sectional</a></h2>
                                        ...
                                        <div class="cart-total-box mt-4 bg-transparent p-0">
                                            ...
                                            <div class="mt-4 checkout-promo-code">
                                                <input class="input-promo-code" type="text"
